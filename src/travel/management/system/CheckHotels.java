...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel[] label = new JLabel[]{l1,l2,l3,l4,l5,l5,l6,l7,l8,l9,l10};
    JLabel caption;
    
    public void run(){
        
        String[] text = new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Ciassio Hotel","Bay Club Hotel,","Breeze Hotel","Happy Hotel","The Taj Hotel","River View Hotel"};                                      
        try{
            for(int i=0;i<=9;i++){
